		...
		<div class="w3-container w3-light-gray">
			...
			<%
				if(request.getParameter("er") != null && request.getParameter("er").equals("true"))
					out.println("<center><h6 style=color:red>Incorrect Credit Card Information</h6></center>");
			%>
				<TABLE border>
					<tr>
						<td>Movie Title</td>
			...
			<form action="/BrickBreakerMovies/ConfirmationPage.jsp"
				  method="POST">
				<center>
					...
					Credit card: <input type="TEXT" name="id">&nbsp
